{\handel\Huge The Clan of Saar} \hfill {\Large Difficulty: \medium} \vspace{-4pt}\\
...
\item \name{Commander - Rowl Sarrig} \textcolor{gray}{(\emph{Unlock:} Have 3 space docks on the game board.)}\\
