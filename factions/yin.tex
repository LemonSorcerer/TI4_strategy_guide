{\handel\Huge The Yin Brotherhood} \hfill {\Large Difficulty: \easy} \vspace{-4pt}\\
...
\item \name{Commander - Brother Omar} \textcolor{gray}{(\emph{Unlock:} Use one of your faction abilities)}\\
...
\item \name{Hero - Dannel of the Tenth / Quantum Dissemination} \textcolor{gray}{(\emph{Unlock:} Have 3 scored objectives)}\\
