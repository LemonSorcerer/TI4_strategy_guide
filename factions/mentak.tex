...
\item \name{Commander - S'Ula Mentarion} \textcolor{gray}{(\emph{Unlock}: Have 4 cruisers on the game board)}\\
\emph{After you win a space combat:}\\
You may force your opponent to give you 1 promissory note from their hand.
\item \name{Hero - Ipswitch, Loose Cannon / Sleeper Cell} \textcolor{gray}{(\emph{Unlock}: Have 3 scored objectives)}\\
