{\handel\Huge The Winnu} \hfill {\Large Difficulty: \medium} \vspace{-4pt}\\
...
\item \name{Hero - Mathis Mathinus / Imperial Seal} \textcolor{gray}{(\emph{Unlock:} Have 3 scored objectives)}\\
