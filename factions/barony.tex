...
\item \name{Commander - Rear Admiral Farran} \textcolor{gray}{(\emph{Unlock:} Have 5 non-fighter ships in 1 system.)}\\
\emph{After 1 of your units uses \emph{Sustain Damage}:}
\\
You may gain 1 Trade Good. 
\item \name{Hero - Darktalon Treilla / Dark Matter Affinity} \textcolor{gray}{(\emph{Unlock:} Have 3 scored objectives)}\\
