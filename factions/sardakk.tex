...
\item \name{Agent - UNKNOWN}\\
UNKNOWN.
\item \name{Commander - UNKNOWN} \textcolor{gray}{(\emph{Unlock:} Control 5 planets in non-home systems.)}
...
\item \name{Hero - UNKNOWN / Tekklar Conditioning} \textcolor{gray}{(\emph{Unlock:} Have 3 scored objectives)}\\
