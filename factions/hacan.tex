{\handel\Huge The Emirates of Hacan} \hfill {\Large Difficulty: \medium} \vspace{-4pt}\\
...
\item \name{Commander - Gila the Silvertongue} \textcolor{gray}{(\emph{Unlock:} Have 10 Trade Goods)}\\
\emph{When you cast votes:}
\\
You may spend any number of trade goods; cast 2 additional votes for each trade good spent. 
\item \name{Hero - Harrugh Gefhara / Galactic Securities Net} \textcolor{gray}{(\emph{Unlock:} Have 3 scored objectives)}\\
